...
def _____menux_____():
        clear()
        print(f'{age}1{pore}BANGLADESH CRACK');print(f'{age}2{pore}MALAYSIA CRACK');linex();option=input(f'{z}CHOICE : ')
        if option in ["1"]:os.system("./RANDOM")
        if option in ["2"]:_____Alhamdulillah_____()
